      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Apoio jurídico especializado para garantir os direitos do seu filho com autismo.
          </h2>
          <p className="text-lg text-muted-foreground">
            Já ajudamos pais e responsáveis de autistas a garantirem os seus direitos.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <Card className="p-8 bg-card border-border hover:border-primary/50 transition-all hover:scale-105 duration-300">
            ...
            <p className="text-muted-foreground">
              Anos de atuação específica em saúde mental
            </p>
          </Card>
          ...
          <Card className="p-8 bg-card border-border hover:border-primary/50 transition-all hover:scale-105 duration-300">
            ...
            <p className="text-muted-foreground">
              Cuidado e acompanhamento contínuo de cada um dos casos.
            </p>
          </Card>
        </div>
